 ...
 * reachable.
 *
 * ID-148.10 (TECH §3.1(d), INV-12(d)): the former ID-90 U7 "capability-theme
 * third leg" coverage (roadmap link binding) is REMOVED — `capability_theme`
 * write has no initiatives analog and was retired from ledger-transaction.ts.
 * Promote is a two-leg (task-list + backlog) transaction only, covered
 * below.
 */
