...
const EMITTED_CLASSES: readonly string[] = [
  ...
  "record-view-initiatives-index-table",
  "record-view-initiatives-index-count",
  ...
  // ID-148.10 (Option C) — initiatives tree-view (repurposed from the
  // retired roadmap-theme arm; INV-13 nested initiative -> sub-initiative
  // -> project tree; Checker CSS-parity fix)
  "record-view-initiative-description",
  "record-view-initiative-transitional-links",
  "record-view-initiative-projects",
  "record-view-initiative-sub-initiatives",
  "record-view-empty-section",
  "record-view-sub-initiative",
  "record-view-sub-initiative-status",
  "record-view-sub-initiative-substrate-doc",
  "record-view-sub-initiative-description",
  "record-view-sub-initiative-projects",
  "record-view-project",
  "record-view-project-summary",
  "record-view-project-status",
  "record-view-project-description",
  "record-view-project-substrate-doc",
  "record-view-project-linked-tasks",
  "record-view-project-linked-backlog",
  "record-view-project-blocking",
  "record-view-empty-linked",
  "record-view-move-form",
  "record-view-project-create-form",
